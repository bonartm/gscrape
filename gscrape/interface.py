...
class SearchInterface():   
    ...
    def __init__(self, url: str, lat: Union[None, float], lon: Union[float, None], graphical:bool, proxy: Union[None, str], mongo_uri: Union[None, str]):
    ...
    async def _init(self, queryterm) -> pyppeteer.page.Page:
        if self.browser is None:
            raise TypeError("Browser was not launched yet. Please use the 'async with' syntax.")
